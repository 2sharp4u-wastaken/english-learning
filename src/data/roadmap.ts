...
export const ROADMAP: RoadmapItem[] = [
  ...
  {
    status: 'considering',
    title: 'שמיעת ההקלטה במשחקי דיבור באנדרואיד',
    detail: 'במכשירי אנדרואיד אי אפשר כרגע לשמוע את ההקלטה של עצמך אחרי הדיבור (הזיהוי והשמירה מתנגשים). נבדקת דרך לאפשר זאת דרך שירות תמלול בענן — תדרוש חיבור לאינטרנט.',
  },
  {
    status: 'considering',
