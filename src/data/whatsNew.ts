...
export const RELEASES: Release[] = [
  {
    version: '3.0.11',
    date: '2026-07-10',
    title: 'אפשר ללחוץ על כל מילה במשפט כדי לשמוע ולתרגם',
    items: [
      { kind: 'feature', text: 'במשחקי המשפטים (a/an/the, זמנים, דקדוק) אפשר עכשיו ללחוץ על כל מילה — גם מילים שכבר נלמדו — כדי לשמוע אותה ולראות את התרגום לעברית. מילים חדשות עדיין מודגשות כמו קודם, ושאר המילים ניתנות ללחיצה בעדינות.' },
    ],
  },
  {
    version: '3.0.10',
    date: '2026-07-08',
    title: 'שיאים אישיים לכל המשחקים — לא רק לזיכרון',
    items: [
      { kind: 'feature', text: 'בסטטיסטיקות יש עכשיו טאב "שיאים" שמראה את השיאים האישיים בכל המשחקים: המשחק הכי חזק, כמה משחקים סיימת ב‑100%, והשיא בכל משחק — ולא רק במשחק הזיכרון.' },
      { kind: 'improve', text: 'השיאים המפורטים של משחק הזיכרון (זמן, מהלכים וכוכבים לכל רמה) עברו לתוך אותו טאב "שיאים", כך שכל ההישגים נמצאים במקום אחד.' },
    ],
  },
  {
    version: '3.0.9',
    date: '2026-07-08',
    title: 'עוד מילים מתורגמות במשחקי המשפטים — ותיקוני תצוגה',
    items: [
      { kind: 'feature', text: 'במשחקי המשפטים (a/an/the, זמנים, דקדוק) גם מילים נפוצות שהילד/ה עדיין לא למד/ה — כמו need, running, rode — ניתנות עכשיו ללחיצה כדי לשמוע אותן ולראות את התרגום לעברית, בדיוק כמו מילים מהמאגר.' },
      { kind: 'fix', text: 'משחק הזיכרון: הקלפים, התמונות והטקסט גדלו במסכים קטנים, ובמצב לרוחב הקלפים כבר לא מתכווצים לנקודה.' },
      { kind: 'fix', text: 'מסך הבית מסתדר יפה גם כשמחזיקים את הטלפון לרוחב.' },
      { kind: 'fix', text: 'התרגום של המילה right במשפטים כמו "right now" לא יופיע יותר בטעות כ"ימין".' },
    ],
  },
  {
    version: '3.0.8',
    date: '2026-07-06',
    title: 'גיבוי ההתקדמות לענן — אותו פרופיל בכמה מכשירים',
    items: [
      { kind: 'feature', text: 'עם חשבון ענן אפשר עכשיו לגבות את ההתקדמות של כל ילד/ה לענן — ולשחזר אותה במכשיר אחר. כך אפשר לשחק באותו פרופיל גם בטאבלט וגם במחשב.' },
      { kind: 'feature', text: 'בהגדרות ההורים, בכרטיס חשבון הענן, אפשר להפעיל גיבוי לכל פרופיל בלחיצה — וגם לגבות או לשחזר ידנית בכל רגע.' },
      { kind: 'improve', text: 'אחרי שמפעילים גיבוי, ההתקדמות נשמרת לענן אוטומטית תוך כדי משחק — בלי לחשוב על זה.' },
    ],
  },
  {
    version: '3.0.7',
    date: '2026-07-05',
    title: 'ההתקדמות שמורה יותר — גיבוי, אבטחה ותיקונים מתחת למכסה',
    items: [
      { kind: 'feature', text: 'גיבוי לקובץ: בהגדרות ההורים אפשר עכשיו לשמור את כל הפרופילים וההתקדמות לקובץ, ולשחזר ממנו — למקרה שהדפדפן נמחק או במעבר מכשיר.' },
      { kind: 'feature', text: 'בחשבון הענן נוספו ייצוא של כל הנתונים ומחיקת החשבון לצמיתות — הנתונים של הילדים בשליטתכם.' },
      { kind: 'improve', text: 'האפליקציה מבקשת מהדפדפן לשמור על הנתונים שלה, ואם שמירה נכשלת (למשל כשאין מקום במכשיר) — מופיעה אזהרה ברורה במקום לאבד התקדמות בשקט.' },
      { kind: 'improve', text: 'שמירת ההתקדמות חכמה יותר — המשחקים מגיבים חלק יותר, במיוחד בטאבלטים ישנים.' },
      { kind: 'improve', text: 'אבטחת הסיסמאות במכשיר שודרגה, וההרשמה לחשבון הענן מוגנת מפני שימוש לרעה.' },
      { kind: 'fix', text: 'מילה שנכתבה פעם באות גדולה ופעם באות קטנה נספרה בטעות כשתי מילים — עכשיו ההתקדמות שלה מאוחדת.' },
    ],
  },
  {
    version: '3.0.6',
