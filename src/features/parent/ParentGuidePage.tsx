  ...
  return (
    ...
    >
      ...
      <GuideCard icon={<Sparkles size={18} />} title="מה האפליקציה עושה">
        משחק ללימוד אנגלית לילדים דוברי עברית בגילאי 5–8. הילד מתקדם במסלול למידה
        מובנה: מילים חדשות נחשפות, נלמדות ונכנסות לתרגול חוזר, ומשחקים מתקדמים נפתחים
        ככל שהילד צובר אוצר מילים. ההתקדמות נשמרת על המכשיר הזה בלבד.
      </GuideCard>
      ...
      <GuideCard icon={<Lock size={18} />} title="אזור ההורה והסיסמה">
        ...
        שכחתם את הסיסמה? בחלון הסיסמה יש קישור "שכחתי סיסמה" שמאפס ומגדיר סיסמה חדשה.
      </GuideCard>

      <GuideCard icon={<Unlock size={18} />} title="פתיחת כל התכנים">
        בהגדרות המוגנות (לשונית "מתקדם") יש מתג "פתיחת כל התכנים". הפעלתו פותחת מיד
        את כל המשחקים והביטויים, ללא תלות בהתקדמות הילד — נוח להצגה או לבדיקה. כיבוי
        המתג מחזיר את הנעילות הרגילות וההתקדמות נשמרת כפי שהייתה.
      </GuideCard>

      <GuideCard icon={<Users size={18} />} title="ניהול הילדים">
        ...
        משותפות לכל הילדים על המכשיר.
      </GuideCard>

      <GuideCard icon={<Gamepad2 size={18} />} title="היכן נמצא מה">
        הילד רואה בהגדרות רק את לשונית "תצוגה" (ניקוד, אותיות וקונפטי) — הכול שאר
