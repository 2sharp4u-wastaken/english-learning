      ...
      <AnimatePresence>
        {bubbleVisible ? (
          <motion.div
            ...
            className="absolute left-1/2 top-full z-10 mt-2 w-max max-w-[15rem] -translate-x-1/2 rounded-2xl border border-white/10 bg-surface px-4 py-2 text-center text-sm font-semibold text-text shadow-panel"
          >
            {message}
          </motion.div>
        ) : null}
